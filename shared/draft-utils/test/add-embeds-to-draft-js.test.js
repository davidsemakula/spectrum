...
describe('sites', () => {
  ...
  describe('thread urls', () => {
    it('should handle full thread urls', () => {
      const text =
        'https://chat.grindery.io/spectrum/general/hello~4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
    ...
    it('should handle /thread/:id urls', () => {
      const text =
        'https://chat.grindery.io/thread/4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?thread urls with query params before', () => {
      const text =
        'https://chat.grindery.io/?m=asdf&thread=4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?thread urls with query params after', () => {
      const text =
        'https://chat.grindery.io/?thread=4026b1bd-3896-46a4-9ade-e621a90e64ad&m=asdf';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?t urls', () => {
      const text =
        'https://chat.grindery.io/?t=4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?t urls with query params before', () => {
      const text =
        'https://chat.grindery.io/?m=asdf&t=4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?t urls with query params after', () => {
      const text =
        'https://chat.grindery.io/?t=4026b1bd-3896-46a4-9ade-e621a90e64ad&m=asdf';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
